...
class SalaLiderRegionalScreen extends ConsumerWidget {
  static const String name = 'SalaLiderRegionalScreen';
  SalaLiderRegionalScreen({super.key});
