...
//
//     final salaHs = salaHsFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

List<SalaHs> salaHsFromJson(String str) =>
    List<SalaHs>.from(json.decode(str).map((x) => SalaHs.fromJson(x)));

String salaHsToJson(List<SalaHs> data) =>
...
class SalaHs {
  ...
  factory SalaHs.fromJson(Map<String, dynamic> json) => SalaHs(
