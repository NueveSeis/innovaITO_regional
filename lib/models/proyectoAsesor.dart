...
class ProyectoAsesor {
  ...
  String descripcionProblematica;
  String estadoArte;
  String descripcionInnovacion;
  String propuestaValor;
  String mercadoPotencial;
  dynamic imagenMercadoPotencial;
  String viabilidadTecnica;
  dynamic imagenViabilidadTecnica;
  String viabilidadFinanciera;
  dynamic imagenViabilidadFinanciera;
  String estrategiaPropiedadIntelectual;
  dynamic imagenPropiedadIntelectual;
  String interpretacionResultados;
  String fuentesConsultadas;
  String nombreCorto;
