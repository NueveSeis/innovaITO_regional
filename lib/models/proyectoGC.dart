...
//
//     final proyectoGc = proyectoGcFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

List<ProyectoGc> proyectoGcFromJson(String str) =>
    List<ProyectoGc>.from(json.decode(str).map((x) => ProyectoGc.fromJson(x)));

String proyectoGcToJson(List<ProyectoGc> data) =>
...
class ProyectoGc {
  ...
  factory ProyectoGc.fromJson(Map<String, dynamic> json) => ProyectoGc(
        folio: json["Folio"],
