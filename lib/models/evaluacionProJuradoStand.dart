...
//
//     final evaluacionProJuradoStand = evaluacionProJuradoStandFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

List<EvaluacionProJuradoStand> evaluacionProJuradoStandFromJson(String str) =>
    List<EvaluacionProJuradoStand>.from(
        json.decode(str).map((x) => EvaluacionProJuradoStand.fromJson(x)));

String evaluacionProJuradoStandToJson(List<EvaluacionProJuradoStand> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class EvaluacionProJuradoStand {
  String folio;
  ...
  factory EvaluacionProJuradoStand.fromJson(Map<String, dynamic> json) =>
      EvaluacionProJuradoStand(
        folio: json["Folio"],
