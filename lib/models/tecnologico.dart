...
List<Tecnologico> tecnologicoFromJson(String str) => List<Tecnologico>.from(json.decode(str).map((x) => Tecnologico.fromJson(x)));

String tecnologicoToJson(List<Tecnologico> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
